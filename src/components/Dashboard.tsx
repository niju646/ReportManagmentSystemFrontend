...
//   // State to manage selected notification types for filtering
//   const [selectedTypes, setSelectedTypes] = useState<string[]>([]);
//   // State to control the type dropdown visibility
//   const [isTypeDropdownOpen, setIsTypeDropdownOpen] = useState(false);
//   // State to manage selected statuses for filtering
//   const [selectedStatuses, setSelectedStatuses] = useState<string[]>([]);
//   // State to control the status dropdown visibility
//   const [isStatusDropdownOpen, setIsStatusDropdownOpen] = useState(false);
//   // State to manage date filters
...
//   // Handle checkbox change for status filtering
...
//   // Filter notifications based on selected types, statuses, and dates
//   const filteredNotifications = summary?.notifications.filter((notification) => {
//     const matchesType = selectedTypes.length === 0 || selectedTypes.includes(notification.type);
//     const matchesStatus =
//       selectedStatuses.length === 0 ||
//       (notification.summary &&
//         (selectedStatuses.includes("delivered") && notification.summary.delivered > 0 ||
//          selectedStatuses.includes("sent") && notification.summary.sent > 0 ||
//          selectedStatuses.includes("failed") && notification.summary.failed > 0 ||
//          selectedStatuses.includes("pending") && notification.summary.pending > 0));
...
const Dashboard: React.FC = () => {
  ...
  // Filter notifications based on selected types, statuses, dates, and webinar title
  const filteredNotifications = summary?.notifications.filter((notification) => {
    const matchesType = selectedTypes.length === 0 || selectedTypes.includes(notification.type);
    const matchesStatus =
      selectedStatuses.length === 0 ||
    ...
    const matchesWebinar =
      !webinarFilter || notification.webinarTitle?.toLowerCase().includes(webinarFilter.toLowerCase());

    return matchesType && matchesStatus && matchesStartDate && matchesEndDate && matchesWebinar;
  }) || [];
  ...
  // Get unique webinar titles for autocomplete suggestions
        ...
        {selectedNotificationId && selectedReport ? (
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 mb-6">
              ...
              {/* Webinar Filter with Autocomplete */}
              <div className="w-full md:w-auto">
